...
async function seed() {
  ...
  const productsData = [
    { name: "خاتم زواج ذهبي عيار 21", nameFr: "Bague de mariage en or 21 carats", slug: "gold-wedding-ring-21k", description: "خاتم زواج فاخر من الذهب عيار 21، صُنع يدوياً بحرفية عالية.", descriptionFr: "Bague de mariage de luxe en or 21 carats.", sku: "FA-RNG-001", karat: "K21", weight: 5, goldPrice: 1300, profitMargin: 200, calculatedPrice: 7500, stock: 10, isFeatured: true, isNew: true, certification: "شهادة أصالة معتمدة", categoryId: rings.id },
    ...
    { name: "أقراط ذهبية عيار 21", nameFr: "Boucles d'oreilles en or 21 carats", slug: "gold-earrings-21k", description: "أقراط ذهبية عيار 21 بتصميم راقي.", descriptionFr: "Boucles d'oreilles élégantes en or 21 carats.", sku: "FA-EAR-003", karat: "K21", weight: 3.5, goldPrice: 1300, profitMargin: 180, calculatedPrice: 5130, stock: 15, isFeatured: true, isNew: true, certification: "شهادة أصالة معتمدة", categoryId: earrings.id },
    { name: "سوار ذهبي عيار 24", nameFr: "Bracelet en or 24 carats", slug: "gold-bracelet-24k", description: "سوار ذهبي عيار 24 عالي الجودة.", descriptionFr: "Bracelet en or pur 24 carats.", sku: "FA-BRC-004", karat: "K24", weight: 15, goldPrice: 1500, profitMargin: 220, calculatedPrice: 25800, stock: 3, isFeatured: true, isNew: false, certification: "شهادة أصالة معتمدة", categoryId: bracelets.id },
    { name: "طقم ذهبي كامل عيار 21", nameFr: "Parure complète en or 21 carats", slug: "gold-set-21k", description: "طقم مجوهرات ذهبي كامل يشمل خاتم وقلادة وأقراط.", descriptionFr: "Parure complète en or 21 carats.", sku: "FA-SET-005", karat: "K21", weight: 25, goldPrice: 1300, profitMargin: 300, calculatedPrice: 40000, stock: 2, isFeatured: false, isNew: true, certification: "شهادة أصالة معتمدة", categoryId: sets.id },
    ...
    { name: "سلاسل ذهبية عيار 21", nameFr: "Chaîne en or 21 carats", slug: "layered-necklace-21k", description: "قلادة سلاسل متعددة الطبقات من الذهب عيار 21.", descriptionFr: "Collier à chaînes superposées en or 21 carats.", sku: "FA-NCK-007", karat: "K21", weight: 12, goldPrice: 1300, profitMargin: 280, calculatedPrice: 19560, stock: 6, isFeatured: false, isNew: true, certification: "شهادة أصالة معتمدة", categoryId: necklaces.id },
    { name: "أقراط لؤلؤ ذهبية عيار 21", nameFr: "Boucles d'oreilles perle en or 21 carats", slug: "pearl-earrings-21k", description: "أقراط ذهبية عيار 21 مع حبات لؤلؤ طبيعي.", descriptionFr: "Boucles d'oreilles en or 21 carats avec perles naturelles.", sku: "FA-EAR-008", karat: "K21", weight: 4, goldPrice: 1300, profitMargin: 220, calculatedPrice: 6080, stock: 8, isFeatured: false, isNew: false, certification: "شهادة أصالة معتمدة", categoryId: earrings.id },
  ];

  const productImages: Record<string, string[]> = {
    "gold-wedding-ring-21k": ["https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&q=80", "https://images.unsplash.com/photo-1603561591411-07134e71a2a9?w=800&q=80"],
    ...
    "gold-earrings-21k": ["https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=800&q=80", "https://images.unsplash.com/photo-1630019852942-f89202989a59?w=800&q=80"],
    "gold-bracelet-24k": ["https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=800&q=80", "https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=800&q=80"],
    "gold-set-21k": ["https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=800&q=80"],
    ...
    "layered-necklace-21k": ["https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&q=80"],
    "pearl-earrings-21k": ["https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=800&q=80", "https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=800&q=80"],
  };
